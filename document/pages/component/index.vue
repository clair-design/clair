...
<h3>笔记标题</h3><p><strong>马克飞象</strong>会自动使用文档内出现的第一个标题作为笔记标题。例如本文，就是第一行的 <code>欢迎使用马克飞象</code>。</p>
<h3>快捷编辑</h3><p>保存在印象笔记中的笔记，右上角会有一个红色的编辑按钮，点击后会回到<strong>马克飞象</strong>中打开并编辑该笔记。</p>
<blockquote>
<p><strong>注意：</strong>目前用户在印象笔记中单方面做的任何修改，马克飞象是无法自动感知和更新的。所以请务必回到马克飞象编辑。</p>
</blockquote>
<h3>数据同步</h3><p><strong>马克飞象</strong>通过<strong>将Markdown原文以隐藏内容保存在笔记中</strong>的精妙设计，实现了对Markdown的存储和再次编辑。既解决了其他产品只是单向导出HTML的单薄，又规避了服务端存储Markdown带来的隐私安全问题。这样，服务端仅作为对印象笔记 API调用和数据转换之用。</p>
<blockquote>
...
<VueDemo0/>
<input id="vdMTEzNDYwMzA" type="checkbox" />
<label for="vdMTEzNDYwMzA"></label>
...
</span><span class="hljs-tag"><span>&lt;</span>/<span class="hljs-name">script</span>&gt;</span></code>
</pre>
</div>
<h3>Demo 2</h3><pre v-pre class="lang-javascript">
...
<div class="vue-demo-block">
<VueDemo1/>
<input id="vdMTY2OTEzMA" type="checkbox" />
<label for="vdMTY2OTEzMA"></label>
<pre v-pre class="lang-html">
...
<span class="hljs-tag">&lt;<span class="hljs-name">c-button</span> <span class="hljs-attr">disabled</span>&gt;</span>禁用按钮<span class="hljs-tag"><span>&lt;</span>/<span class="hljs-name">c-button</span>&gt;</span></code>
</pre>
</div>
...
<script>
  ...
  __vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vue-demo"},[_c('div',{staticClass:"wrapper"},[_c('button',{on:{"click":function($event){_vm.incr(-1)}}},[_vm._v("decrease")]),_vm._v(" "),_c('input',{attrs:{"type":"text","readonly":""},domProps:{"value":_vm.count}}),_vm._v(" "),_c('button',{on:{"click":function($event){_vm.incr(+1)}}},[_vm._v("increase")])])])}
  ...
  if (module.exports.__esModule) module.exports = module.exports.default
  var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
  __vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"vue-demo"},[_c('c-button',[_vm._v("默认按钮")]),_vm._v(" "),_c('c-button',{attrs:{"primary":""}},[_vm._v("主操作按钮")]),_vm._v(" "),_c('c-button',{attrs:{"disabled":""}},[_vm._v("禁用按钮")])],1)}
  __vue__options__.staticRenderFns = []
...
<style>
.wrapper[data-v-bba68bf6]{backgroun:red}
</style>
